...
from data.dataset import parquets_iter_batched
...
parser.add_argument("--doc_cap", type=int, default=10_000, help="Maximum char per document (default 10k)")
...
t0 = time.time()
tokenizer = BPETokenizer.train_from_iterator(text_iter, vocab_size=args.vocab_size)
t1 = time.time()
train_time = t1 - t0
